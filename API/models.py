...
class AtpSingles(Base):
    ...
    loser_id=Column(BigInteger,ForeignKey("atp_players.players_id"))
...
class AtpDoubles(Base):
    ...
    winner1_seed= Column(String)
    winner1_entry=Column(String)
    winner1_age=Column(BigInteger,default=False)
    winner2_id= Column(BigInteger,ForeignKey("atp_players.player_id"))
    winner2_seed= Column(String)
    winner2_entry=Column(String)
    winner2_age=Column(BigInteger,default=False)
    loser1_id=Column(BigInteger,ForeignKey("atp_players.players_id"))
    loser1_seed=Column(String)
    loser1_entry=Column(String)
    loser1_age=Column(Float)
    loser2_id=Column(BigInteger,ForeignKey("atp_players.players_id"))
    loser2_seed=Column(String)
    loser2_entry=Column(String)
...
class WtaQualifiersItf(Base):
    __tablename__='wta_qualifiers_itf'
